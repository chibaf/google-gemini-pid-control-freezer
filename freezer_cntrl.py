...
# --- Configuration ---
SERIAL_PORT = '/dev/ttyACM0'  # Check this name (may be ttyUSB0 or similar)
BAUDRATE = 9600               # Match the baudrate of your serial device
GPIO_PIN = 17                 # The GPIO pin (BCM mode) connected to the freezer relay
